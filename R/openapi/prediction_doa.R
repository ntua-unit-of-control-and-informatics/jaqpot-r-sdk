...
#' @docType class
#' @title PredictionDoa
#' @description PredictionDoa Class
#' @format An \code{R6Class} generator object
#' @field id  integer [optional]
#' @field method  \link{DoaMethod}
#' @field data The doa calculated data named list(\link{AnyType})
...
PredictionDoa <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PredictionDoa class.
    #'
    #' @param method method
    #' @param data The doa calculated data
    #' @param id id
    ...
    #' To JSON String
    #'
    #' @return PredictionDoa in JSON format
    toJSON = function() {
      PredictionDoaObject <- list()
      if (!is.null(self$`id`)) {
        PredictionDoaObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`method`)) {
        PredictionDoaObject[["method"]] <-
          self$`method`$toJSON()
      }
      if (!is.null(self$`data`)) {
        PredictionDoaObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`createdAt`)) {
        PredictionDoaObject[["createdAt"]] <-
          self$`createdAt`
      }
      if (!is.null(self$`updatedAt`)) {
        PredictionDoaObject[["updatedAt"]] <-
          self$`updatedAt`
      }
      PredictionDoaObject
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PredictionDoa
    #'
    #' @param input_json the JSON input
    #' @return the instance of PredictionDoa
...
',
    ...
    #' @description
    #' Validate JSON input with respect to PredictionDoa and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`method`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionDoa: the required field `method` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionDoa: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PredictionDoa
    toString = function() {
      self$toJSONString()
    },
...
# PredictionDoa$unlock()
#
## Below is an example to define the print function
# PredictionDoa$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
