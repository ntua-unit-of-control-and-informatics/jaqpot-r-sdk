#' Create a new MulticlassClassificationScores
#'
#' @description
#' MulticlassClassificationScores Class
#'
#' @docType class
#' @title MulticlassClassificationScores
#' @description MulticlassClassificationScores Class
...
MulticlassClassificationScores <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MulticlassClassificationScores class.
    #'
    #' @param yName yName
    #' @param labels labels
    #' @param folds folds
    ...
    #' To JSON String
    #'
    #' @return MulticlassClassificationScores in JSON format
    toJSON = function() {
      MulticlassClassificationScoresObject <- list()
      if (!is.null(self$`labels`)) {
        MulticlassClassificationScoresObject[["labels"]] <-
          self$`labels`
      }
      if (!is.null(self$`yName`)) {
        MulticlassClassificationScoresObject[["yName"]] <-
          self$`yName`
      }
      if (!is.null(self$`folds`)) {
        MulticlassClassificationScoresObject[["folds"]] <-
          self$`folds`
      }
      if (!is.null(self$`accuracy`)) {
        MulticlassClassificationScoresObject[["accuracy"]] <-
          self$`accuracy`
      }
      if (!is.null(self$`balancedAccuracy`)) {
        MulticlassClassificationScoresObject[["balancedAccuracy"]] <-
          self$`balancedAccuracy`
      }
      if (!is.null(self$`precision`)) {
        MulticlassClassificationScoresObject[["precision"]] <-
          self$`precision`
      }
      if (!is.null(self$`recall`)) {
        MulticlassClassificationScoresObject[["recall"]] <-
          self$`recall`
      }
      if (!is.null(self$`f1Score`)) {
        MulticlassClassificationScoresObject[["f1Score"]] <-
          self$`f1Score`
      }
      if (!is.null(self$`jaccard`)) {
        MulticlassClassificationScoresObject[["jaccard"]] <-
          self$`jaccard`
      }
      if (!is.null(self$`matthewsCorrCoef`)) {
        MulticlassClassificationScoresObject[["matthewsCorrCoef"]] <-
          self$`matthewsCorrCoef`
      }
      if (!is.null(self$`confusionMatrix`)) {
        MulticlassClassificationScoresObject[["confusionMatrix"]] <-
          lapply(self$`confusionMatrix`, function(x) x$toJSON())
      }
      MulticlassClassificationScoresObject
    },

    #' @description
    #' Deserialize JSON string into an instance of MulticlassClassificationScores
    #'
    #' @param input_json the JSON input
    #' @return the instance of MulticlassClassificationScores
...
',
    ...
    #' @description
    #' Validate JSON input with respect to MulticlassClassificationScores and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`yName`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MulticlassClassificationScores: the required field `yName` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MulticlassClassificationScores
    toString = function() {
      self$toJSONString()
    },
...
# MulticlassClassificationScores$unlock()
#
## Below is an example to define the print function
# MulticlassClassificationScores$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MulticlassClassificationScores$lock()
